...
@Entity
@Table(name = "ehr_parameter_report_details")
public class ParameterReportDetail implements Serializable {
	...
	@EmbeddedId
	private ParameterReportId parameterReportId;
	...
	public ParameterReportId getParameterReportId() {
		return parameterReportId;
	}

	public void setParameterReportId(ParameterReportId parameterReportId) {
