...
public interface ClientDao {
	...
	String saveClientMaster(ClientMaster clientMaster);
	...
	JSONArray rejectedReportList(String centerId, String startDate,
	...
	void updatEmailResponseAPI(JSONArray jsonArray);
