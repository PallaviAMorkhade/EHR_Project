...
%>
<body> <!-- onload="getUploadedReport(<%-- <%=session.getAttribute("clientId") %> --%>)" -->
	...
	%>
										...
										<div class="tabbable no-margin no-padding">
											<ul class="nav nav-tabs" id="myTab">
												...
												<li onclick="loadOtherDetailsPage()" class="active padding-top-5 menu_7" style="display:none;"><a data-toggle="tab"
											...
											<div class="tab-content">
												<div id="otherDetails" class="tab-pane fade padding-bottom-5 in active">
													<div class="row">
														<div class="col-md-10">
															<!-- <a id="verificationFailed" class="list-group-item list-group-item-danger hidden"
																href="#"> <b>Oh Snap! Verification Failed -
														...
														<div class="col-md-2">
															<div class="col-md-12 space20">
																<button id="clientUploadReportBtn" type="button" class="btn btn-primary start" onclick="clientUploadReport()" style="display:none;">
...
<!-- {% if (file.error) { %}
	...
	<script src="<c:url value="/indus/resources/custom_js/indus_patient_other_details.js"/>"></script>
