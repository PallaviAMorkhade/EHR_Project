								...
								<div class="wrap-content container" id="container">
									<div class="container-fluid container-fullw bg-white"
										...
										<div class="row">
											...
											<div class="col-md-1 col-sm-2 col-xs-3 margin-top-57">
												<button type="button" class="btn btn-info"
													onclick="getRecordByDateAnalysis()">Search</button>
											</div>
											...
											<div class="col-md-3 col-sm-6 col-xs-12 margin-top-3">
												<div class="form-group">
													...
													<input class="form-control" placeholder="Search"
														id="searchBoxAnalysis" name="searchBox" type="search"
														autocomplete="off">
												</div>
											</div>
											...
											<div class="col-md-2 col-sm-6 col-xs-12 margin-top-3">
												<div class="form-group">
													<h5 class="text-bold margin-top-25 margin-bottom-15">Client
														Id</h5>
													<input type="text" id="searchByClientId"
											...
											<div class="col-md-2 col-sm-6 col-xs-12 margin-top-3">
												<div class="form-group">
													<h5 class="text-bold margin-top-25 margin-bottom-15">Member
														Id</h5>
													<input type="text" id="searchByMemberId"
														class="form-control" placeholder="Search">
												</div>
											</div>

											<!-- <div class="col-md-2 margin-top-3">
												<div class="form-group">
											...
											<div class="col-md-1 margin-top-57">
												<button type="button" class="btn btn-info"
